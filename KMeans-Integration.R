...
getwd()
write.csv (titanic, file = "C:\\Users\\prade\\Documents\\Kmean\\titanicNew.csv")

titanic <- read.csv("titanicNew.csv")
...
options(digits = 2) #upto 2 decimal places


#####Step 4####
titanicNew=read.csv("C:\\Users\\prade\\Documents\\Kmean\\titanicNew.csv")
...
write.csv(titanicUpdated,file = "C:\\Users\\prade\\Documents\\Kmean\\titanicUpdated.csv")
